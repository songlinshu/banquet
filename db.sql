create database if not EXISTS banquet default character set utf8 default collate utf8_general_ci;
...
create table users(
    ...
    nickname varchar(20) unique null  comment "昵称",
    is_auth boolean null default 0 comment "是否认证为厨师",
    is_admin boolean null default 0 comment "是否是管理员",
    ...
    is_cook boolean null default 0 comment "是否是厨师，0 不是， 1 是",
